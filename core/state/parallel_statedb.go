...
// IsVerkle reports whether the underlying trie is verkle-based.
// Firehose / vm.StateDB surface: delegates to the raw base StateDB.
func (s *ParallelStateDB) IsVerkle() bool {
	if s.rawBase == nil {
		return false
	}
	return s.rawBase.IsVerkle()
}
